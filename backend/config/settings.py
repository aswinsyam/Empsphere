...
"DEFAULT_AUTHENTICATION_CLASSES": (
        "apps.common.middleware.authentication.JWTAuthentication",
    ),
    "DEFAULT_PERMISSION_CLASSES": (
        "apps.authentication.permissions.IsAuthenticatedUser",
    ),
    "DEFAULT_RENDERER_CLASSES": (
        "rest_framework.renderers.JSONRenderer",
    ),
    "EXCEPTION_HANDLER": (
        "apps.common.exceptions.exception_handler.custom_exception_handler"
    ),
}
